  ...
  <div class="box-cont box-list-room">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sort): $mod = ($i % 2 );++$i;?><div class="list-li">
	  <div class="table">
	    ...
	    <div class="bd td">
	      <span><?php echo ($sort['name']); ?> (容纳人数:<?php echo ($sort['num']); ?>)</span>
	    </div>
	    <div class="bd2 td">
		  ...
		  <?php if(is_array($sort['houseslist'])): $i = 0; $__LIST__ = $sort['houseslist'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$house): $mod = ($i % 2 );++$i;?><div class="ft">
		    <div class="fl">
		      <img src="<?php echo ($house['image']); ?>" height="150">
		    </div>
		    <div class="fr">
		      <p>房间号：<?php echo ($house['name']); ?></p>
		      <p>房间介绍：<?php echo ($house['note']); ?></p>
		    </div>
