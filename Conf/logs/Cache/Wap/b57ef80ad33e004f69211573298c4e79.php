...
<div class="contxt cont-artical">
	<form action="<?php echo U('Hotels/saveorder',array('token' => $_GET['token'], 'wecha_id' => $wecha_id));?>" class="new_hotel_order" data-validate="true" id="new_hotel_order" method="post" novalidate="novalidate">
	...
	<div class="box-cont box-txt">
		<p><span>支付方式：</span>
			<?php if($alipayConfig['open'] == 1): ?><b><input name="paymode" value="1" type="radio" id="paymod_1" checked><label for="paymod_1">在线支付</label></b>　<?php endif; ?>
			<b><input name="paymode" value="3" type="radio" id="paymod_3" checked><label for="paymod_3">门店支付</label></b>　
			<?php if($fans['balance'] > 0): ?><b><input name="paymode" value="4" type="radio" id="paymod_4"><label for="paymod_4">会员卡支付</label></b>　<?php endif; ?>
		</p>
