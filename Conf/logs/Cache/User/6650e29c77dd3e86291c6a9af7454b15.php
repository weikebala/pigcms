...
<div class="content">
          ...
          <div class="cLine">
    <div class="alert">
    <p><span class="bold">请添加您的预约列表。</span> <a class="btn" href="javascript:location.reload()">刷新</a></p>
    </div>
</div>
          ...
          <div class="cLine">
            ...
            <div class="pageNavigator left">
                <a href="<?php echo U('Estate/reservation_add',array('token'=>$token,'type'=>'house_book'));?>" class="btnGrayS vm bigbtn">
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                <?php if(is_array($reslist)): $i = 0; $__LIST__ = $reslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php if($vo['typename2'] != ''): echo ($vo['typename2']); endif; if($vo['typename3'] != ''): ?>/<?php echo ($vo['typename3']); endif; ?></td>
                        <td >
