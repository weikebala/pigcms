...
<div class="content">
  <div class="cLineB">
    ...
    <a href="<?php echo U('Market/cate',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
  </div>
...
<table class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
 <tbody>
      <tr>
            ...
            <td><input type="input" class="px" id="cate_name" value="<?php echo ($cate['cate_name']); ?>" name="cate_name" style="width:400px">
              <br>
            </td>
            <td></td>
      </tr>
<tr>
  ...
  <td>
    <input type="input" class="px" id="cate_pic" value="<?php echo ($cate['cate_pic']); ?>" name="cate_pic"  style="width:350px" >
    <script src="<?php echo STATICS;?>/upyun.js"></script>
    <a href="javascript:void(0);" onclick="upyunPicUpload('cate_pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a>
...
<tr>
  ...
  <td align="left"><input type="input" class="px" id="sort" value="<?php if($cate['sort'] == ''): ?>50<?php else: echo ($cate['sort']); endif; ?>" name="sort" >
  </td>
  <td></td>
</tr> 
  <!--
<tr>
  ...
  <td><input type="input" class="px" id="sort" value="<?php if($cate['sort'] == 0): ?>50<?php else: echo ($cate['sort']); endif; ?>" name="sort" style="width:200px">
  </td>
  <td></td>
</tr>  
