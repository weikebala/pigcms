...
<thead>
	<tr>
		<th width="100">问题</th>
		<th width="200">选项</th>
		<th width="120">选择次数</th>
	</tr>
</thead>
<tbody>
<tr></tr>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tablelist): $mod = ($i % 2 );++$i; if(is_array($tablelist['answer'])): $k = 0; $__LIST__ = $tablelist['answer'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$answer): $mod = ($k % 2 );++$k;?><tr>
		<?php if($k == 1): ?><td rowspan="<?php echo ($tablelist['rowspan']); ?>"><?php echo ($tablelist['name']); ?></td><?php endif; ?>
		<td><?php echo ($answer['name']); ?></td>
		<td><?php echo ($answer['nums']); ?></td>
