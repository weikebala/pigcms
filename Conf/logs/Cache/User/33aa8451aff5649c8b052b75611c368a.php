...
<div class="content">
  <div class="cLineB">
    <h4>停车区域<?php if($park["park_id"] > '0'): ?>修改<?php else: ?>添加<?php endif; ?></h4>
    <a href="<?php echo U('Market/park',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
  </div>
...
<table class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
 <tbody>
      <tr>
            ...
            <td><input type="input" class="px" id="park_name" value="<?php echo ($park['park_name']); ?>" name="park_name" style="width:400px">
              <br>
            </td>
            <td></td>
      </tr>
<tr>
  <th valign="top"><span class="red">*</span><label for="keyword">车位数量：</label></th>
  <td><input type="input" class="px" id="park_num" value="<?php echo ($park['park_num']); ?>" name="park_num" style="width:400px">
  </td>
  <td></td>
</tr> 
<tr>
  <th valign="top"><label for="keyword">是否使用：</label></th>
  <td align="left"><input type="checkbox" class="px" id="is_use" value="1" name="is_use" <?php if($park['is_use'] == 1): ?>checked<?php endif; ?>>
  </td>
  <td></td>
</tr>  
...
function setlatlng(longitude,latitude){
  ...
  art.dialog.open('<?php echo U('Map/setLatLng',array('token'=>$token,'id'=>$id));?>',{lock:false,title:'设置经纬度',width:600,height:400,yesText:'关闭',background: '#000',opacity: 0.87});
          ...
          <tr>
            <th valign="top"><label for="keyword">区域介绍</label></th>
            <td>
                <textarea class="px" id="park_intro" name="park_intro" style="width:400px;height:200px"><?php echo ($park['park_intro']); ?></textarea>
            </td>
            <td></td>
          </tr>
  <tr>
