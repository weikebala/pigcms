...
<ul id="tags" style="width:100%">
		<li>
				<a href="?g=User&m=Message&a=index">发送消息</a> 
			</li>
			<li class="selectTag">
...
<div class="mediaHead"><span class="title" id="zbt"><?php echo ($img["title"]); ?></span><span class="time"><?php echo date('Y-m-d',time());?></span>
<div class="clr"></div>
</div>
<div class="mediaImg"><img id="suicaipic1" src="<?php echo ($img["pic"]); ?>"></div>
<div class="mediaContent mediaContentP">
<p id="zinfo"><?php echo ($img["text"]); ?></p>
</div>
