...
<div class="cLineB">
  ...
  <form action="" id="formID" method="post" class="form-horizontal form-validate" novalidate="novalidate">
 <?php if($reslist['id'] != ''): ?><input type="hidden" name="id" id="id" value="<?php echo ($reslist['id']); ?>"/><?php endif; ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="keyword" id="keyword" class="span4"   value="<?php echo ($reslist['keyword']); ?>" data-validation-engine="validate[required,minSize[1]]"
                    data-errormessage-value-missing="必填项!" ><span class="maroon">*</span><span class="help-inline">只能设置一个关键字</span>
        </div>
    </div>
    ...
    <div class="control-group">
      ...
      <input id="picurl" type="text" class="span4" name="picurl" class="input-xlarge"  schoolSet data-rule-url="true" value="<?php echo ($reslist['picurl']); ?>" />
...
<div class="control-group">
         ...
         <div class="controls">
             <input type="text" name="tel" id="tel" class="span4" value="<?php echo ($reslist['tel']); ?>"  schoolSet  placeholder="请输入接收预约的电话号码"/><span class="maroon">*</span><span class="help-inline">如 0551-65371998</span>
         </div>
     </div>
     <div class="control-group">
         <label for="estate_desc" class="control-label">排序：</label>
         <div class="controls">
             <input type="number" name="take" id="take" class="span4" value="<?php echo ($reslist['take']); ?>"  data-validation-engine="validate[custom[integer],min[1]]"
                    data-errormessage-value-missing="必填项!"   placeholder=""/><span class="maroon">*</span><span class="help-inline"></span>
         </div>
     </div>
     <div class="control-group">
...
<?php if($reslist['headpic'] != ''): ?><img class="thumb_img" id="headpic_src" src="<?php echo ($reslist['headpic']); ?>" style="max-height: 100px;"><?php endif; ?>
              <input id="headpic"type="text"class="input-large" name="headpic" class="span4 px"   data-rule-url="true" value="<?php echo ($reslist['headpic']); ?>" />
 ...
 <div class="control-group" >
     <label for="typename" class="control-label">预约限定量：</label>
     <div class="controls">
        <input type="number" name="typename" placeholder="请输入本次预约允许最多人数" value="<?php echo ($reslist['typename']); ?>" class="span4" data-validation-engine="validate[required,custom[integer],min[1]]"
                    data-errormessage-value-missing="必填项!" > &nbsp;单位/人
    </div>
</div>

 <div class="control-group" >
    <label for="date" class="control-label">开始/结束 时间：</label>
    <div class="controls">
    <div class="input-prepend">
<input type="input" class="px" id="typename2" value="<?php if($reslist['typename2'] != ''): echo ($reslist['typename2']); endif; ?>" onClick="WdatePicker()" name="typename2">
到
<input type="input" class="px" id="typename3" value="<?php if($reslist['typename3'] != ''): echo ($reslist['typename3']); endif; ?>" name="typename3" onClick="WdatePicker()">
